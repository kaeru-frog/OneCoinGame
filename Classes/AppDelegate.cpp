...
static cocos2d::Size designResolutionSize = cocos2d::Size(360, 640);	// c’·‚É‚·‚é
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("OneCoinGame", Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("OneCoinGame");
#endif
